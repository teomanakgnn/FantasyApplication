...
<head>
  ...
  <style>
    ...
    /* iframe kaydirilabilir bir sarmalayicinin icinde.
       - iOS duzlestirirse: iframe uzar, sarmalayici kaydirir
       - duzlestirmezse   : iframe viewport boyunda, kendi icinde kayar
       Iki durumda da calisir. */
    #app-scroll {
      position: fixed;
      inset: 0;
      overflow-y: auto;
