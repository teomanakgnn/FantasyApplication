...
# --- TRADE ANALYZER FONKSİYONLARI (DÜZELTİLMİŞ) ---
...
def get_impact_class(diff, category):
    ...
    threshold = 0.001  # Çok küçük değişimler için
